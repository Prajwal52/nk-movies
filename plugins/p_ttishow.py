...
async def save_group(bot, message):
  ...
  if temp.ME in r_j_check:
    ...
    if message.chat.id in temp.BANNED_CHATS:
      ...
      return
    buttons = [[
      InlineKeyboardButton('𝙷𝙾𝚆 𝚃𝙾 𝚄𝚂𝙴 𝙼𝙴',
                           url=f"https://t.me/{temp.U_NAME}?start=help"),
      InlineKeyboardButton('📢 UᎮDΛTΞS 📢', url='https://t.me/nk_moviezzz')
    ]]
    reply_markup = InlineKeyboardMarkup(buttons)
      ...
      for u in message.new_chat_members:
        ...
        temp.MELCOW['welcome'] = await message.reply_video(
          ...
          reply_markup=InlineKeyboardMarkup([
            [
              InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ',
                                   url="t.me/+KYKkWH_CAyA3OGY1"),
              InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url="t.me/nk_moviezzz")
            ],  #[InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/sai_nishchai27")]]),
          ]),
